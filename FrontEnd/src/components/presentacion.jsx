...
export default function CreatePresentacion() {
    ...
    function handleClicked(event) {
        ...
        fetch("http://127.0.0.1:8000/api/presentaciones/", {
            method: 'POST',
            headers: {
    ...
    return (
        <form>
            ...
            <button type="submit" onClick={handleClicked}>Crear presentación</button>
        </form>
    )
}
